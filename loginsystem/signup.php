...
if($numExitrow >0){
    // $exists = true ;
    $showError = "This Username are Already Existed !" ;
}
else{
    // $exists = false ; 
...
if( $showAlert){
    ...
    <strong>Success!</strong> Your account are now created and you can login .
...
?>
    ...
    <div class="conainer">
        ...
        <form action="/loginsystem/signup.php" method="post" class = "   text-center harishflexbox" >
            <div class="mb-3">
